...
class AutoComplete extends Common
{
	...
	protected function displayHtml()
	{
		...
		$javascript = '
			<script type="text/javascript">
				...
				{
					$("input[type=text]#'.$this->mateInstances[0].'name").autocomplete({
	...
	protected function initiateEditor()
	{
		...
		$this->Editor->setConfig('tableTitle','Subscriptions <div style="font-size: 12px; font-weight: normal;">applied to the subscriber</div>');
